...
export async function POST(request: NextRequest) {
	...
	const auth = 'Bearer aoet6vauviklip6dml26svnmla3pk3'; // Der Einfachhalt halber erstmal hardcoded. Muss eigentlich aus der DB ausgelesen und regelmäßig refreshed werden
